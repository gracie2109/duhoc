...
function PageHeaderShell({
    ...
    return (
        <div className="w-full relative">
            <Comp className={cn("flex justify-between items-center relative", className)} {...props}>
                {children}
            </Comp>
            {separated ? <Separator className="absolute top-20"/>: null}
        </div>
    )
}
...
export { PageHeader, PageHeaderDescription, PageHeaderHeading,PageHeaderShell }
